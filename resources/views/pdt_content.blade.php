		...
		<div class="swipe" id="mySwipe">
			<div class="swipe-wrap">
				@foreach ($pdt_images as $pdt_image)
					<div>
						<a href="javascript:;"><img src="{{$pdt_image->image_path}}" class="img-responsive" alt=""></a>
					</div>
				@endforeach
			</div>
		</div>
...
<div class="bk_fix_bottom">
	...
	<div class="bk_half_area">
		<button class="weui_btn weui_btn_primary" onclick="_toCart();">查看购物车(<span id="cart_num" class="m3_price">{{$count}}</span>)</button>
	</div>
</div>
@endsection
