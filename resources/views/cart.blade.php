...
@section('content')
				...
				<label for="{{$cart_item->product->id}}" class="weui_cell weui_check_label">
					...
					<div class="weui_cell_bd weui_cell_primary">
						<div style="position: relative;">
							<img src="{{$cart_item->product->preview}}" onclick="_toProduct({{$cart_item->product->id}});" alt="" class="bk_preview m3_preview">
	...
	<div class="bk_half_area">
		<button class="weui_btn weui_btn_primary" onclick="_toDelete();">删除</button>
	</div>
</div>
@endsection
